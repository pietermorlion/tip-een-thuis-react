    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
            ...
            {[
              {
                ...
                text: (
                  <>
                    ...
                    <a href="#formulier" className="underline underline-offset-4 text-emerald-700 hover:text-emerald-800">formulier</a>.
                  </>
                ),
              },
              { step: "2", title: "Wij bekijken je tip", text: "We delen je tip met de geschikte partnerorganisatie. Zij nemen contact op." },
              { step: "3", title: "Ontvang een beloning", text: "Leidt je tip effectief tot verhuur of verkoop? Dan krijg jij een beloning." },
            ].map((s) => (
      ...
      <section id="wat" className="border-t border-neutral-200 bg-neutral-50">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-4 max-w-3xl text-neutral-700 text-lg">We zoeken kwalitatieve, veilige woningen met correcte prijzen.</p>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              <h3 className="text-lg font-semibold">Gent</h3>
              <ul className="mt-3 space-y-2 text-neutral-700">
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Huurwoningen (EHVV, Thope)</li>
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Koopwoningen & appartementen (Pandschap Invest)</li>
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Bouwgrond (CLT Gent)</li>
              </ul>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              <h3 className="text-lg font-semibold">Brugge</h3>
              <ul className="mt-3 space-y-2 text-neutral-700">
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Huurwoningen (Huizen van de Vrede)</li>
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Koopwoningen (MORE LION, Pandschap Invest)</li>
              </ul>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6">
              <h3 className="text-lg font-semibold">Heel België</h3>
              <ul className="mt-3 space-y-2 text-neutral-700">
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Huurwoningen via PATHS (Fedasil & IOM)</li>
                <li className="flex items-start gap-2"><span className="mt-1 h-2 w-2 rounded-full bg-emerald-600" />Eigenaars die willen verhuren/verkopen aan de doelgroep</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          {sent ? (
            <div className="rounded-2xl border border-emerald-200 bg-emerald-50 p-6">
              ...
              <p className="mt-2 text-sm text-emerald-900">We koppelen terug zodra een partner je tip heeft bekeken.</p>
            </div>
          ) : (
      ...
      <section id="beloning" className="border-t border-neutral-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-16">
          ...
          <p className="mt-3 text-neutral-700">Kies je beloning wanneer je tip effectief leidt tot verhuur of verkoop aan de doelgroep.</p>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            ...
            <article className="overflow-hidden rounded-2xl border border-neutral-200 bg-neutral-50">
              ...
              <div className="p-5">
                ...
                <p className="mt-2 text-sm text-neutral-700">Bij succesvolle <em>verkoop</em>. Verblijf in Finca La Perla Verde.</p>
      ...
      <section id="partners" className="border-t border-neutral-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14">
          ...
          <p className="mt-3 max-w-3xl text-neutral-700">
            Tip een Thuis is een burgerinitiatief met organisaties die actief zijn rond huisvesting en steun aan vluchtelingen.
          </p>

          <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
            {partners.map((p) => (
              <article key={p.key} className="rounded-2xl border border-neutral-200 bg-neutral-50 p-6 shadow-sm">
          ...
          <div className="mt-12 border-t border-neutral-200 pt-6">
            ...
            <div className="grid grid-cols-2 gap-6 md:grid-cols-6">
              {partners.map((p) => (
                <div key={`${p.key}-footer`} className="flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 gap-6 md:grid-cols-6">
                <div className="flex items:center justify-center">
                  <a href="https://enjoymicasa.be" target="_blank" rel="noreferrer" aria-label="enjoymicasa.be">
                    <LogoImg base="enjoymicasa" className="max-h-12 w-auto opacity-90 grayscale hover:opacity-100 hover:grayscale-0" alt="enjoymicasa logo" />
                  </a>
                </div>
              </div>
            </div>
